...
本地运行、认证 bootstrap 和日常巡视步骤详见 `docs/architecture/ops-001-local-runbook.md`。当前治理巡视详见 `docs/architecture/ops-002-governance-readiness-check.md`。MVP API smoke 测试基线详见 `docs/architecture/e2e-001-smoke-test-baseline.md`。
